                                            ...
                                            <div className="slider-content">
                                                <div className="banner_shadow" id="element">
                                                    ...
                                                    <div className="slider__content">
                                                        <p><a className="more" href="/appointment/">Book Online</a><a className="more" href="tel:02070780822"><i className="fa fa-phone"></i> Call</a></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="slide-2">
                                        ...
                                        <div className="slider-content">
                                            ...
                                            <div className="button-appointment">
                                                <a href="/appointment/" className="more">Book An Appointment</a>
                                            </div>
                                        </div>    
                                    </div>  
